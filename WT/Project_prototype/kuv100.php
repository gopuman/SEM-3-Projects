...
<head>
  <?php
    ...
    $sql = "SELECT * from car_details where model_name = 'kuv100'";
...
<br><br><br><br><br>
  <h1>Mahindra KUV100</h1>
  <div id="relative">
    <h3>Starting at Rs4,50,000</h3>
    <p>color picker</p>
...
<span class="fa fa-star "></span>
  ...
  <div class="mySlides fade">
    ...
    <img src="kuv100.jpg" style="width:100%">
    <div class="text" >White</div>
  </div>

  <div class="mySlides fade">
    <div class="numbertext">2 / 3</div>
    <img src="kuvred.jpg" style="width:100%">
    <div class="text" >Red</div>
  </div>

  <div class="mySlides fade">
    <div class="numbertext">3 / 3</div>
    <img src="kuvgrey.jpg" style="width:100%">
...
<center>
  <div>
    ...
    <table border="1px">
      ...
      <tr>
        <td>Mahindra KUV100 K2 6 STR</td>
        <td>4,50,000</td>
        <td>1.2</td>
        <td>petrol</td>
        <td>3,50,000</td>
        <td>70 per hr(Fuel Free)</td>
      </tr>
      <tr>
        <td>Mahindra KUV100 K2 D 6 STR</td>
        <td>5,50,000</td>
        <td>1.2</td>
        <td>diesel</td>
        <td>4,50,000</td>
