...
<head>
  <?php
    ...
    $sql = "SELECT * from car_details where model_name = 'creta'";
...
<span class="fa fa-star"></span>
  ...
  <div class="mySlides fade">
    ...
    <img src="creta.png" style="width:100%">
    <div class="text">White</div>
  </div>

  <div class="mySlides fade">
    <div class="numbertext">2 / 3</div>
    <img src="cretared.jpg" style="width:100%">
    <div class="text" style="color:black;">Red</div>
  </div>

  <div class="mySlides fade">
    <div class="numbertext">3 / 3</div>
    <img src="cretagrey.jpg" style="width:100%">
...
<center>
  <div>
    ...
    <table border="1px">
      ...
      <tr>
        <td>Hyundai Creta E 1.6 Petrol</td>
        <td>9,30,000</td>
        <td>1.6</td>
        <td>petrol</td>
        <td>8,30,000</td>
      ...
      <tr>
        <td>Hyundai Creta S 1.4 CRDI</td>
        <td>11,00,000</td>
        <td>1.4</td>
        <td>diesel</td>
        <td>10,00,000</td>
