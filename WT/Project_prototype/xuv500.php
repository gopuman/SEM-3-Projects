...
<head>
  <?php
    ...
    $sql = "SELECT * from car_details where model_name = 'xuv500'";
...
<span class="fa fa-star "></span>
  ...
  <div class="mySlides fade">
    ...
    <img src="xuv500.png" style="width:100%">
    <div class="text" >White</div>
  </div>

  <div class="mySlides fade">
    <div class="numbertext">2 / 3</div>
    <img src="xuv500red.png" style="width:100%">
    <div class="text" >Red</div>
  </div>

  <div class="mySlides fade">
    <div class="numbertext">3 / 3</div>
    <img src="xuv500grey.png" style="width:100%">
