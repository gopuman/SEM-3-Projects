...
<head>
  <?php
    ...
    $sql = "SELECT * from car_details where model_name = 'amaze'";
...
<span class="fa fa-star"></span>
  ...
  <div class="mySlides fade">
    ...
    <img src="hondaamaze.jpg" style="width:100%">
    <div class="text" style="color:black;">White</div>
  </div>

  <div class="mySlides fade">
    <div class="numbertext">2 / 3</div>
    <img src="amazered.jpg" style="width:100%">
    <div class="text" >Red</div>
  </div>

  <div class="mySlides fade">
    <div class="numbertext">3 / 3</div>
    <img src="amazegrey.jpg" style="width:100%">
