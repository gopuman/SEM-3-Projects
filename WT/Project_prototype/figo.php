...
<head>
  <?php
    ...
    $sql = "SELECT * from car_details where model_name = 'figo'";
...
<span class="fa fa-star "></span>
  ...
  <div class="mySlides fade">
    ...
    <img src="figo.jpg" style="width:100%">
    <div class="text" style="color:black;">White</div>
  </div>

  <div class="mySlides fade">
    <div class="numbertext">2 / 3</div>
    <img src="figored.jpg" style="width:100%">
    <div class="text" style="color:black;">Red</div>
  </div>

  <div class="mySlides fade">
    <div class="numbertext">3 / 3</div>
    <img src="figogrey.jpg" style="width:100%">
