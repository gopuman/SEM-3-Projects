...
<head>
  <?php
    ...
    $sql = "SELECT * from car_details where model_name = 'baleno'";
...
<span class="fa fa-star"></span>
  ...
  <div class="mySlides fade">
    ...
    <img src="baleno.jpg" style="width:100%">
    <div class="text">White</div>
  </div>

  <div class="mySlides fade">
    <div class="numbertext">2 / 3</div>
    <img src="balenored.jpg" style="width:100%">
    <div class="text" style="color:black;">Red</div>
  </div>

  <div class="mySlides fade">
    <div class="numbertext">3 / 3</div>
    <img src="balenogrey.jpg" style="width:100%">
