...
<head>
  <?php
    ...
    $sql = "SELECT * from car_details where model_name = 'gla'";
...
<br><br><br><br><br>
  <h1>Mercedez-Benz GLA</h1>
  <div id="relative">
    <h3>Starting at Rs31,00,000</h3>
    <p>color picker</p>
...
<span class="fa fa-star checked"></span>
  ...
  <div class="mySlides fade">
    ...
    <img src="gla.jpg" style="width:100%">
    <div class="text" style="color:black;">White</div>
  </div>

  <div class="mySlides fade">
    <div class="numbertext">2 / 3</div>
    <img src="glared.jpg" style="width:100%">
    <div class="text" >Red</div>
  </div>

  <div class="mySlides fade">
    <div class="numbertext">3 / 3</div>
    <img src="glagrey.jpg" style="width:100%">
