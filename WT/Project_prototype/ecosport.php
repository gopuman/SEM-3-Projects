...
<head>
  <?php
    ...
    $sql = "SELECT * from car_details where model_name = 'ecosport'";
...
<span class="fa fa-star"></span>
  ...
  <div class="mySlides fade">
    ...
    <img src="ecosport.jpg" style="width:100%">
    <div class="text" style="color:black;">White</div>
  </div>

  <div class="mySlides fade">
    <div class="numbertext">2 / 3</div>
    <img src="ecosportred.jpg" style="width:100%">
    <div class="text" >Red</div>
  </div>

  <div class="mySlides fade">
    <div class="numbertext">3 / 3</div>
    <img src="ecosportgrey.jpg" style="width:100%">
...
<center>
  <div>
    ...
    <table border="1px">
      ...
      <tr>
        <td>Ford Ecosport 1.5L Ti-VCT</td>
        <td>7,30,000</td>
        <td>1.5</td>
        <td>petrol</td>
        <td>6,30,000</td>
