...
<head>
  <?php
    ...
    $sql = "SELECT * from car_details where model_name = 'civic'";
...
<br><br><br><br><br>
  <h1>Honda Civic(New generation release)</h1>
  <div id="relative">
    <h3>Starting at Rs13,00,000</h3>
    <p>color picker</p>
...
<span class="fa fa-star"></span>
  ...
  <div class="mySlides fade">
    ...
    <img src="civicred.jpg" style="width:100%">
    <div class="text">Red</div>
  </div>

  <div class="mySlides fade">
    <div class="numbertext">3 / 3</div>
    <img src="civicgrey.jpg" style="width:100%">
