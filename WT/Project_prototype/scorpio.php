...
<head>
  <?php
    ...
    $sql = "SELECT * from car_details where model_name = 'scorpio'";
  ...
  <center>
    <div class="image">
      ...
      <a id = "linkref" href = "homepage1.php">Home</a>
			<a id = "linkref" href = "CarHome1.html">Buy</a>
			<a id = "linkref" href = "CarHome1.html">Rent</a>
			<a id = "linkref" href = "CarHome1.html">Sell</a>
...
<span class="fa fa-star "></span>
  ...
  <div class="mySlides fade">
    ...
    <img src="scorpio.jpg" style="width:100%">
    <div class="text" >White</div>
  </div>

  <div class="mySlides fade">
    <div class="numbertext">2 / 3</div>
    <img src="scorpiored.jpg" style="width:100%">
    <div class="text" >Red</div>
  </div>

  <div class="mySlides fade">
    <div class="numbertext">3 / 3</div>
    <img src="scorpiogrey.jpg" style="width:100%">
...
<center>
  <div>
    ...
    <table border="1px">
      ...
      <tr>
        <td>Mahindra Scorpio S3 2WD</td>
        <td>10,00,000</td>
        <td>2.5</td>
        <td>petrol</td>
        <td>9,00,000</td>
        <td>100 per hr(Fuel Free)</td>
      </tr>
      <tr>
        <td>Mahindra Scorpio S5 2WD</td>
        <td>11,50,000</td>
        <td>2.5</td>
        <td>diesel</td>
        <td>10,50,000</td>
