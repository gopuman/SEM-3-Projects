...
<head>
  <?php
    ...
    $sql = "SELECT * from car_details where model_name = 'ciaz'";
...
<span class="fa fa-star"></span>
  ...
  <div class="mySlides fade">
    ...
    <img src="ciaz.jpg" style="width:100%">
    <div class="text" style="color:black;">White</div>
  </div>

  <div class="mySlides fade">
    <div class="numbertext">2 / 3</div>
    <img src="ciazred.jpg" style="width:100%">
    <div class="text" style="color:black;">Red</div>
  </div>

  <div class="mySlides fade">
    <div class="numbertext">3 / 3</div>
    <img src="ciazgrey.jpg" style="width:100%">
...
<center>
  <div>
    ...
    <table border="1px">
      ...
      <tr>
        <td>Maruti Ciaz Sigma 1.4 MT</td>
        <td>8,00,000</td>
        <td>1.4</td>
        <td>petrol</td>
        <td>7,00,000</td>
