...
<head>
  <?php
    ...
    $sql = "SELECT * from car_details where model_name = 'endeavour'";
...
<span class="fa fa-star checked"></span>
  ...
  <div class="mySlides fade">
    ...
    <img src="endeavour.jpg" style="width:100%">
    <div class="text" style="color:black;">White</div>
  </div>

  <div class="mySlides fade">
    <div class="numbertext">2 / 3</div>
    <img src="endeavourred.jpg" style="width:100%">
    <div class="text" style="color:black;">Red</div>
  </div>

  <div class="mySlides fade">
    <div class="numbertext">3 / 3</div>
    <img src="endeavourgrey.jpg" style="width:100%">
...
<center>
  <div>
    ...
    <table border="1px">
      ...
      <tr>
        <td>Ford Endeavour Trend 2.2 4x2 AT</td>
        <td>25,00,000</td>
        <td>2.2</td>
        <td>petrol</td>
        <td>24,00,000</td>
      ...
      <tr>
        <td>Ford Endeavour Titanium 2.2 4x2 AT</td>
        <td>28,00,000</td>
        <td>2.2</td>
        <td>diesel</td>
        <td>27,00,000</td>
